---
description: Tutorial on how to gather UTXOs and send BTC with Go.
---

# Send BTC (gather UTXOs)

---

### Full code

[transfer_coin.go](https://github.com/miguelmota/bitcoin-development-with-go-book/blob/master/code/transfer_coin.go)
